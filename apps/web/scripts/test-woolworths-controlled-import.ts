...
assert.deepEqual(categoryForWoolworthsPath("/shop/browse/pantry/snacks-confectionery", "Bakers South African Lemon Cream Biscuits"), { category: "Pantry", productType: ProductType.PACKAGED });
