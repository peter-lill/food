...
export const pilotSelections = [
  ...
  { query: "Coles Soft Wholemeal Sandwich Loaf 700g", category: "Bakery", type: ProductType.BAKERY },
  { query: "Coles Oats Rolled 900g", category: "Pantry", type: ProductType.PACKAGED },
  { query: "Coles Simply White Long Grain Rice 1kg", category: "Pantry", type: ProductType.PACKAGED },
  { query: "Coles Durum Wheat Pasta Penne Rigate 500g", category: "Pantry", type: ProductType.PACKAGED },
  { query: "Coles Simply Plain Flour 1kg", category: "Pantry", type: ProductType.PACKAGED },
  { query: "Coles White Sugar 1kg", category: "Pantry", type: ProductType.PACKAGED },
  { query: "Coles Australian Diced Tomatoes 400g", category: "Pantry", type: ProductType.PACKAGED },
  { query: "Coles Simply Chick Peas 420g", category: "Pantry", type: ProductType.PACKAGED },
  ...
  { query: "Pepsi Max No Sugar Cola Soft Drink Bottle 1.25L", category: "Drinks", type: ProductType.BEVERAGE },
  { query: "Dare Iced Coffee Double Espresso 750mL", category: "Drinks", type: ProductType.BEVERAGE },
  { query: "Cadbury Dairy Milk Chocolate Block 180g", category: "Snacks & confectionery", type: ProductType.PACKAGED },
  { query: "KitKat Milk Chocolate Block 160g", category: "Snacks & confectionery", type: ProductType.PACKAGED },
  { query: "Arnott's Tim Tam Original 200g", category: "Snacks & confectionery", type: ProductType.PACKAGED },
  { query: "Coles Simply Original Crinkle Cut Chips 175g", category: "Snacks & confectionery", type: ProductType.PACKAGED },
  { query: "Coles Ultra Concentrate Dishwashing Liquid 450mL", category: "Household", type: ProductType.HOUSEHOLD },
  { query: "Coles Simply Toilet Tissue 4 Pack", category: "Household", type: ProductType.HOUSEHOLD },
  { query: "Kleenex Facial Tissue Everyday 2 Ply 200 Pack", category: "Household", type: ProductType.HOUSEHOLD },
  { query: "Coles Ibuprofen Tablets 24 Pack", category: "Health & personal care", type: ProductType.PERSONAL_CARE },
  { query: "Soothers Butter Menthol Liquid Centre Honey Lemon Throat Lozenges 10 Pack", category: "Health & personal care", type: ProductType.PERSONAL_CARE },
  { query: "Coles Organic Carrots 1kg", category: "Fruit & vegetables", type: ProductType.GENERIC_PRODUCE },
