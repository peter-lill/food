...
const concepts: GroceryConcept[] = [
  ...
  { canonicalName: "Dill", aliases: ["dill", "dill herb", "dill leaves", "fresh dill"], family: "Dill", preservePhrase: true },
  { canonicalName: "Broccoli", aliases: ["broccoli"], family: "Broccoli", preservePhrase: true },
  { canonicalName: "Cauliflower", aliases: ["cauliflower"], family: "Cauliflower", preservePhrase: true },
  { canonicalName: "Greek Yoghurt", aliases: ["greek yoghurt", "greek yogurt", "greek style natural yoghurt", "greek style natural yogurt"], family: "Yoghurt", preservePhrase: true },
  ...
  { canonicalName: "Multigrain Bread", aliases: ["multigrain bread", "crusty multigrain bread"], family: "Bread", preservePhrase: true },
  { canonicalName: "White Bread", aliases: ["white bread", "white sandwich loaf", "white sandwich bread"], family: "Bread", preservePhrase: true },
