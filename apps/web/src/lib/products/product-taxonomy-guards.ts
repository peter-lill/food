...
export function guardedProductIdentity(value: string): ProductClassification | null {
  ...
  // These modifiers are especially collision-prone and must be resolved before
  // generic vinegar/honey/sauce/beer/BBQ keyword rules.
  ...
  if ((has(text, ["g&t", "gin and tonic", "gin & tonic"]) && has(text, ["non alcoholic", "non-alcoholic", "alcohol free", "zero alcohol"])) || has(text, ["non alcoholic g&t", "non-alcoholic g&t"])) return result("Drinks", "Cold drinks", "non-alcoholic beverage identity");
  ...
  if (has(text, ["bbq sauce", "barbecue sauce"]) && !has(text, ["chicken wing", "chicken wings", "pork ribs", "beef brisket", "pork shoulder"])) return result("Pantry", "Sauces & condiments", "barbecue sauce identity");
  ...
  if (has(text, ["bbq sausages", "barbecue sausages", "bbq pork ribs", "barbecue pork ribs", "bbq chicken", "barbecue chicken", "bbq beef", "barbecue beef", "pork ribs", "chicken wings", "beef brisket"])) return result("Meat & seafood", "Fresh meat & seafood", "barbecue meat identity");
