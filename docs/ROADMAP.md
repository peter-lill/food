...
Persisted shopping lists, item grouping, mobile check-off, completed-item cleanup, low-stock Pantry quick-adds and receipt-derived price history are implemented. Woolworths, Coles and ALDI price connectors, individual-item and whole-store modes, Springwood list ordering and aisle data remain future work.
